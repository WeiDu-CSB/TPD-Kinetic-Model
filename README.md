...
- WEE1: WEE1 system, reproduce Figure 5A/5B/5E. Adapt this to simulate functional inhibition, inhibition landscape and hook effect of your target of interest. Update measured degradation and activity level data file WEE1_data.csv and parameters in WEE1_main.m with your target of interest.(Estimated run time: <30min)
